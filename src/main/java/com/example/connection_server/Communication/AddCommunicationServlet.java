...
public class AddCommunicationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String get_startTime = UserDAO.GetTextFromRequest(request,"stratTime");
        ...
        if(UserDAO.AddCommunication(get_userId,get_startTime,get_finishTime,get_title,get_address,get_detail,get_participants)){
